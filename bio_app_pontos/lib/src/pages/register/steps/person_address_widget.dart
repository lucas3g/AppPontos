              ...
              children: [
                  ...
                  children: [
                    ...
                    Observer(builder: (_) {
                      return ElevatedButton(
                          ...
                          child: controller.statusCep ==
                                      RegisterStatusCep.success ||
                    ...
                    Form(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) {
                          ...
                          controller.copyWith(uf: value.trim().removeAcentos());
                        },
                    ...
                    Form(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) {
                          ...
                          controller.copyWith(
                              municipio: value.trim().removeAcentos());
                        },
                        onFieldSubmitted: (value) {
                          rua.requestFocus();
                ...
                MyInputWidget(
                  ...
                  onChanged: (String? rua) {
                    controller.copyWith(rua: rua!.trim().removeAcentos());
                  },
                ),
                SizedBox(height: 10),
                MyInputWidget(
                  ...
                  onChanged: (String? numero) {
                    controller.copyWith(numero: numero!.trim().removeAcentos());
                  },
                ),
                SizedBox(height: 10),
                MyInputWidget(
                  ...
                  onChanged: (String? bairro) {
                    controller.copyWith(bairro: bairro!.trim().removeAcentos());
                  },
                ),
                SizedBox(height: 10),
                MyInputWidget(
                  ...
                  onChanged: (String? complemento) {
                    controller.copyWith(
                        complemento: complemento!.trim().removeAcentos());
                  },
                ),
              ],
            ),
